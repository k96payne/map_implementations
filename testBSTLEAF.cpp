...
BSTLEAF< size_t, size_t, compr ,eqls > tree{};
	...
	SECTION( "insert // height // balance // size " ) {
		SECTION( "inserting constantly increasing/decreasing key priorities" ) {
			...
			for( size_t i = 1; i < 500; ++i ) {
				...
				REQUIRE( tree.height() == treeHeight );
				REQUIRE( tree.balance() == treeBalance );
		...
		SECTION( "inserting varying key priorities" ) {
			...
			REQUIRE(tree.balance() == 2 );
			REQUIRE(tree.size() == 5 );

			tree.insert(2,2);
			REQUIRE(tree.height() == 5 );
			REQUIRE(tree.balance() == 3 );
			REQUIRE(tree.size() == 6 );

			tree.insert(3,3);
			REQUIRE(tree.height() == 6 );
			REQUIRE(tree.balance() == 4 );
			REQUIRE(tree.size() == 7 );
...
TEST_CASE( "CASE TWO: Iterators", "[iterator]" ) {
	SECTION( "iterating through list (non const)" ) {
		...
		BSTLEAF< size_t, size_t, compr ,eqls >::iterator iter = tree.begin();
		BSTLEAF< size_t, size_t, compr ,eqls >::iterator end = tree.end();
	...
	SECTION( "iterating through list (const)" ) {
		...
		BSTLEAF< size_t, size_t, compr ,eqls > const Ctree = tree;

		BSTLEAF< size_t, size_t, compr ,eqls >::const_iterator iter = Ctree.begin();
		BSTLEAF< size_t, size_t, compr ,eqls >::const_iterator end = Ctree.end();
	...
	SECTION( "== // != // -> // copy and assignment (non-const)" ) {
		...
		BSTLEAF< size_t, size_t, compr ,eqls >::iterator iterA = tree.begin();
		BSTLEAF< size_t, size_t, compr ,eqls >::iterator iterB = tree.begin();
		BSTLEAF< size_t, size_t, compr ,eqls >::iterator end = tree.end();
		...
		BSTLEAF< size_t, size_t, compr ,eqls >::iterator iterC = tree.begin();
		...
		// check for deep copy
		BSTLEAF< size_t, size_t, compr ,eqls >::iterator iter_copy = tree.begin();
		BSTLEAF< size_t, size_t, compr ,eqls >::iterator iter_copied = tree.begin();
		...
		BSTLEAF< size_t, size_t, compr ,eqls >::iterator iter_copyCon = iter_copy;
		...
		BSTLEAF< size_t, size_t, compr ,eqls >::iterator IT = tree.begin();
		BSTLEAF< size_t, size_t, compr ,eqls >::iterator END = tree.begin();
	...
	SECTION( "== // != // copy and assignment (const)" ) {
		...
		BSTLEAF< size_t, size_t, compr ,eqls >::const_iterator iterA = Ctree.begin();
		BSTLEAF< size_t, size_t, compr ,eqls >::const_iterator iterB = Ctree.begin();
		BSTLEAF< size_t, size_t, compr ,eqls >::const_iterator end = Ctree.end();
		...
		// check for deep copy
		BSTLEAF< size_t, size_t, compr ,eqls >::const_iterator iter_copy = Ctree.begin();
		BSTLEAF< size_t, size_t, compr ,eqls >::const_iterator iter_copied = Ctree.begin();
		...
		BSTLEAF< size_t, size_t, compr ,eqls >::const_iterator iter_copyCon = iter_copy;
...
TEST_CASE( "CASE THREE: Rule of Five Verification", "[rule_of_five]" ) {
	SECTION( "Copy Constructor" ) {
		...
		BSTLEAF< size_t, size_t, compr ,eqls > copy = tree;
	...
	SECTION( "Overload Assignment" ) {
		...
		BSTLEAF< size_t, size_t, compr ,eqls > assign{};
	...
	SECTION( "Move Constructor" ) {
		...
		BSTLEAF< size_t, size_t, compr ,eqls > move = std::move(tree);
	...
	SECTION( "Overload Move Assignment" ) {
		...
		BSTLEAF< size_t, size_t, compr ,eqls > move{};
...
TEST_CASE( "CASE FOUR: error throwing", "[error]" ) {
	...
	SECTION( "iterators" ) {
		...
		BSTLEAF< size_t, size_t, compr ,eqls >::iterator iterB = tree.begin();
		BSTLEAF< size_t, size_t, compr ,eqls >::iterator endB = tree.end();
