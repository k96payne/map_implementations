...
AVL< size_t, size_t, compr ,eqls > tree{};
...
TEST_CASE( "CASE TWO: Iterators", "[iterator]" ) {
	SECTION( "iterating through list (non const)" ) {
		...
		AVL< size_t, size_t, compr ,eqls >::iterator iter = tree.begin();
		AVL< size_t, size_t, compr ,eqls >::iterator end = tree.end();
	...
	SECTION( "iterating through list (const)" ) {
		...
		AVL< size_t, size_t, compr ,eqls > const Ctree = tree;

		AVL< size_t, size_t, compr ,eqls >::const_iterator iter = Ctree.begin();
		AVL< size_t, size_t, compr ,eqls >::const_iterator end = Ctree.end();
	...
	SECTION( "== // != // -> // copy and assignment (non-const)" ) {
		...
		AVL< size_t, size_t, compr ,eqls >::iterator iterA = tree.begin();
		AVL< size_t, size_t, compr ,eqls >::iterator iterB = tree.begin();
		AVL< size_t, size_t, compr ,eqls >::iterator end = tree.end();
		...
		AVL< size_t, size_t, compr ,eqls >::iterator iterC = tree.begin();
		...
		// check for deep copy
		AVL< size_t, size_t, compr ,eqls >::iterator iter_copy = tree.begin();
		AVL< size_t, size_t, compr ,eqls >::iterator iter_copied = tree.begin();
		...
		AVL< size_t, size_t, compr ,eqls >::iterator iter_copyCon = iter_copy;
		...
		AVL< size_t, size_t, compr ,eqls >::iterator IT = tree.begin();
		AVL< size_t, size_t, compr ,eqls >::iterator END = tree.begin();
	...
	SECTION( "== // != // copy and assignment (const)" ) {
		...
		AVL< size_t, size_t, compr ,eqls >::const_iterator iterA = Ctree.begin();
		AVL< size_t, size_t, compr ,eqls >::const_iterator iterB = Ctree.begin();
		AVL< size_t, size_t, compr ,eqls >::const_iterator end = Ctree.end();
		...
		// check for deep copy
		AVL< size_t, size_t, compr ,eqls >::const_iterator iter_copy = Ctree.begin();
		AVL< size_t, size_t, compr ,eqls >::const_iterator iter_copied = Ctree.begin();
		...
		AVL< size_t, size_t, compr ,eqls >::const_iterator iter_copyCon = iter_copy;
...
TEST_CASE( "CASE THREE: Rule of Five Verification", "[rule_of_five]" ) {
	SECTION( "Copy Constructor" ) {
		...
		AVL< size_t, size_t, compr ,eqls > copy = tree;
	...
	SECTION( "Overload Assignment" ) {
		...
		AVL< size_t, size_t, compr ,eqls > assign{};
	...
	SECTION( "Move Constructor" ) {
		...
		AVL< size_t, size_t, compr ,eqls > move = std::move(tree);
	...
	SECTION( "Overload Move Assignment" ) {
		...
		AVL< size_t, size_t, compr ,eqls > move{};
...
TEST_CASE( "CASE FOUR: error throwing", "[error]" ) {
	...
	SECTION( "iterators" ) {
		...
		AVL< size_t, size_t, compr ,eqls >::iterator iterB = tree.begin();
		AVL< size_t, size_t, compr ,eqls >::iterator endB = tree.end();
