...
BSTROOT< size_t, size_t, compr ,eqls > tree{};
...
TEST_CASE( "CASE TWO: Iterators", "[iterator]" ) {
	SECTION( "iterating through list (non const)" ) {
		...
		BSTROOT< size_t, size_t, compr ,eqls >::iterator iter = tree.begin();
		BSTROOT< size_t, size_t, compr ,eqls >::iterator end = tree.end();
	...
	SECTION( "iterating through list (const)" ) {
		...
		BSTROOT< size_t, size_t, compr ,eqls > const Ctree = tree;

		BSTROOT< size_t, size_t, compr ,eqls >::const_iterator iter = Ctree.begin();
		BSTROOT< size_t, size_t, compr ,eqls >::const_iterator end = Ctree.end();
	...
	SECTION( "== // != // -> // copy and assignment (non-const)" ) {
		...
		BSTROOT< size_t, size_t, compr ,eqls >::iterator iterA = tree.begin();
		BSTROOT< size_t, size_t, compr ,eqls >::iterator iterB = tree.begin();
		BSTROOT< size_t, size_t, compr ,eqls >::iterator end = tree.end();
		...
		BSTROOT< size_t, size_t, compr ,eqls >::iterator iterC = tree.begin();
		...
		// check for deep copy
		BSTROOT< size_t, size_t, compr ,eqls >::iterator iter_copy = tree.begin();
		BSTROOT< size_t, size_t, compr ,eqls >::iterator iter_copied = tree.begin();
		...
		BSTROOT< size_t, size_t, compr ,eqls >::iterator iter_copyCon = iter_copy;
		...
		BSTROOT< size_t, size_t, compr ,eqls >::iterator IT = tree.begin();
		BSTROOT< size_t, size_t, compr ,eqls >::iterator END = tree.begin();
	...
	SECTION( "== // != // copy and assignment (const)" ) {
		...
		BSTROOT< size_t, size_t, compr ,eqls >::const_iterator iterA = Ctree.begin();
		BSTROOT< size_t, size_t, compr ,eqls >::const_iterator iterB = Ctree.begin();
		BSTROOT< size_t, size_t, compr ,eqls >::const_iterator end = Ctree.end();
		...
		// check for deep copy
		BSTROOT< size_t, size_t, compr ,eqls >::const_iterator iter_copy = Ctree.begin();
		BSTROOT< size_t, size_t, compr ,eqls >::const_iterator iter_copied = Ctree.begin();
		...
		BSTROOT< size_t, size_t, compr ,eqls >::const_iterator iter_copyCon = iter_copy;
...
TEST_CASE( "CASE THREE: Rule of Five Verification", "[rule_of_five]" ) {
	SECTION( "Copy Constructor" ) {
		...
		BSTROOT< size_t, size_t, compr ,eqls > copy = tree;
	...
	SECTION( "Overload Assignment" ) {
		...
		BSTROOT< size_t, size_t, compr ,eqls > assign{};
	...
	SECTION( "Move Constructor" ) {
		...
		BSTROOT< size_t, size_t, compr ,eqls > move = std::move(tree);
	...
	SECTION( "Overload Move Assignment" ) {
		...
		BSTROOT< size_t, size_t, compr ,eqls > move{};
...
TEST_CASE( "CASE FOUR: error throwing", "[error]" ) {
	...
	SECTION( "iterators" ) {
		...
		BSTROOT< size_t, size_t, compr ,eqls >::iterator iterB = tree.begin();
		BSTROOT< size_t, size_t, compr ,eqls >::iterator endB = tree.end();
