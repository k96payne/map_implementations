...
class BSTROOT {
	...
	public:
		...
		class BSTROOT_Iter {
			public:
				...
				//========================================================//
				using self_type = BSTROOT_Iter;
				using self_reference = BSTROOT_Iter&;
				//========================================================//
				...
				// Factories
				//========================================================//
				static BSTROOT_Iter create_begin( Node * begin, Node * root ) { 
					BSTROOT_Iter I( begin, root ); 
					return I; 
				}
				static BSTROOT_Iter create_end( Node * end, Node * root ) { 
					BSTROOT_Iter I( end, root ); 
					return I;
				}
				//========================================================//
				...
				//========================================================//
				self_reference operator=( BSTROOT_Iter const& I ) {
				...
				bool operator==( BSTROOT_Iter const& rhs ) const {
			...
			private:
				...
				//--------------------------------------------------------//
				BSTROOT_Iter( Node * start, Node * root ) : curr( start ), treeRoot( root ), temp( nullptr ) { }
	...
	public:
		...
		// Copy Constructor
		BSTROOT( const BSTROOT& source );

		// Overload Assignment
		BSTROOT< K, V, cmpr, eqls >& operator=( const BSTROOT& source );

		// Move Constructor
		BSTROOT( BSTROOT&& source );

		// Overload Move Assignment
		BSTROOT< K, V, cmpr, eqls >& operator=( BSTROOT&& source );
	...
	public:
		...
		using key_type = K;
		using value_type = V;
		using iterator = BSTROOT_Iter< key_type, value_type >;
		using const_iterator = BSTROOT_Iter< key_type, value_type >;
...
//========================================================//
template< typename K, typename V, bool (*cmpr)(const K&, const K&), bool (*eqls)(const K&, const K&) >
BSTROOT< K, V, cmpr, eqls >::BSTROOT( void ) : root( nullptr ) { }
//========================================================//
...
//========================================================//
template< typename K, typename V, bool (*cmpr)(const K&, const K&), bool (*eqls)(const K&, const K&) >
BSTROOT< K, V, cmpr, eqls >::BSTROOT( const BSTROOT& source ) : root ( nullptr ) {
...
//========================================================//
template< typename K, typename V, bool (*cmpr)(const K&, const K&), bool (*eqls)(const K&, const K&) >
BSTROOT< K, V, cmpr, eqls >& BSTROOT< K, V, cmpr, eqls >::operator=( const BSTROOT& source ) {
...
//========================================================//
template< typename K, typename V, bool (*cmpr)(const K&, const K&), bool (*eqls)(const K&, const K&) >
BSTROOT< K, V, cmpr, eqls >::BSTROOT( BSTROOT&& source ) : root( nullptr ) {
	root = source.root;
	source.root = nullptr;
}
//========================================================//
...
//========================================================//
template< typename K, typename V, bool (*cmpr)(const K&, const K&), bool (*eqls)(const K&, const K&) >
BSTROOT< K, V, cmpr, eqls >& BSTROOT< K, V, cmpr, eqls >::operator=( BSTROOT&& source ) {
	do_clear( root );
...
//========================================================//
template< typename K, typename V, bool (*cmpr)(const K&, const K&), bool (*eqls)(const K&, const K&) >
BSTROOT< K, V, cmpr, eqls >::~BSTROOT( void ) {
	do_clear( root );
}
//========================================================//
...
//========================================================//
template< typename K, typename V, bool (*cmpr)(const K&, const K&), bool (*eqls)(const K&, const K&) >
void BSTROOT< K, V, cmpr, eqls >::insert( const K& key, V value ) {
	Node * temp = do_lookup(root, key);
	if( temp == nullptr ) do_insert_at_root( root, key, value );
...
//========================================================//
template< typename K, typename V, bool (*cmpr)(const K&, const K&), bool (*eqls)(const K&, const K&) >
V BSTROOT< K, V, cmpr, eqls >::remove( const K& key ) {
	Node * temp = do_lookup(root, key);
	if( temp == nullptr ) throw std::runtime_error( "ERROR: using BSTROOT< > remove(): key not found" );
...
//========================================================//
template< typename K, typename V, bool (*cmpr)(const K&, const K&), bool (*eqls)(const K&, const K&) >
V& BSTROOT< K, V, cmpr, eqls >::lookup( const K& key ) {
	Node * temp = do_lookup(root, key);
	if( temp == nullptr ) throw std::runtime_error( "ERROR: using BSTROOT< > lookup(): key not found" );
	return temp -> value;
}
//========================================================//
...
//========================================================//
template< typename K, typename V, bool (*cmpr)(const K&, const K&), bool (*eqls)(const K&, const K&) >
bool BSTROOT< K, V, cmpr, eqls >::contains( const K& key ) {
	Node * temp = do_lookup( root, key );
...
//========================================================//
template< typename K, typename V, bool (*cmpr)(const K&, const K&), bool (*eqls)(const K&, const K&) >
bool BSTROOT< K, V, cmpr, eqls >::is_empty( void ) {
	return root == nullptr;
}
//========================================================//
...
//========================================================//
template< typename K, typename V, bool (*cmpr)(const K&, const K&), bool (*eqls)(const K&, const K&) >
bool BSTROOT< K, V, cmpr, eqls >::is_full( void ) {
	return false;
}
//========================================================//
...
//========================================================//
template< typename K, typename V, bool (*cmpr)(const K&, const K&), bool (*eqls)(const K&, const K&) >
size_t BSTROOT< K, V, cmpr, eqls >::size( void ) {
...
//========================================================//
template< typename K, typename V, bool (*cmpr)(const K&, const K&), bool (*eqls)(const K&, const K&) >
void BSTROOT< K, V, cmpr, eqls >::clear( void ) {
	do_clear( root );
}
//========================================================//
...
//========================================================//
template< typename K, typename V, bool (*cmpr)(const K&, const K&), bool (*eqls)(const K&, const K&) >
int BSTROOT< K, V, cmpr, eqls >::height( void ) {
...
//========================================================//
template< typename K, typename V, bool (*cmpr)(const K&, const K&), bool (*eqls)(const K&, const K&) >
int BSTROOT< K, V, cmpr, eqls >::balance( void ) {
